...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    // Redirect to the actual customer app login with credentials
    window.location.href = `${config.customerCenterUrl}/login`;
  };
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12 sm:py-20">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Sign in to your {brandName} account</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <a
                    href={`${config.customerCenterUrl}/forgot-password`}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-purple-600 to-blue-500 text-white py-3.5 rounded-xl font-semibold text-base hover:from-purple-700 hover:to-blue-600 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-purple-200 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                onClick={() => window.location.href = `${config.customerCenterUrl}/login`}
              >
